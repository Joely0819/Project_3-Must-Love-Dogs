...
function fetchAnimals(e) {
  ...
  let key = "kiaeBqq6Ftr3Dxsfm2WxHPIEItFWvLbK9EVhzETvgBQeMsLncJ";
  let secret = "yMaSkV2ebAbMvUCOqeNWFNYv1Kp9M1SXqGCVNPm2";
  let token;
  ...
  fetch("https://api.petfinder.com/v2/oauth2/token", {
    ...
    .then(() => {
      ...
      fetch(
        `https://api.petfinder.com/v2/animals?type=${dog}&location=${zip}`,
        {
          method: "GET",
          mode: "cors",
          headers: {
